...
var YearPicker = (_temp = _class = function (_Component) {
    ...
    YearPicker.prototype.render = function render() {
        ...
        var _props = this.props,
            ...
            others = (0, _objectWithoutProperties3.default)(_props, ['prefix', 'rtl', 'locale', 'label', 'state', 'format', 'disabledDate', 'footerRender', 'placeholder', 'size', 'disabled', 'hasClear', 'popupTriggerType', 'popupAlign', 'popupContainer', 'popupStyle', 'popupClassName', 'popupProps', 'className', 'inputProps', 'dateInputAriaLabel', 'yearCellRender']);
